// Write a function named license_checker that checks drivers speed, this function needs to 
// take a parameter named speed.
...
let number=user.questionInt("enter any speed:-");
license_checker(number);